...
(function () {
  ...
  inputFilters = {
    ...
    email: function (element) {
      return (
        $(element)
          .val()
          .match(/.+\@.+\..+/) != null && inputFilters['any'](element)
      );
    },
    phone: function (element) {
      return (
        $(element)
          .val()
          .match(/^\(?(\d{3})\)?[- ]?(\d{3})[- ]?(\d{4})$/) != null && inputFilters['any'](element)
      );
    },
  ...
  validate = function (evt) {
    ...
    if (errors.length !== 0) {
      return this.errorcallback(errors);
    }
  ...
  _IV = function (opts) {
    ...
    this.$inputs
      .focus(function () {
        return focal.apply(this);
      })
      .keydown(function (evt) {
        return keyManager.apply(self, [evt]);
      })
      .blur(function () {
        return blurer.apply(this);
      });

    this.$submit.click(function (evt) {
      return validate.apply(self, [evt]);
    });
